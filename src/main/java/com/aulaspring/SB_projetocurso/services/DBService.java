...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "juliana.silvagomes93@gmail.com", "83862573492", TipoCliente.PESSOAFISICA, pe.encode("12345"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "João Andrade", "julianagomes9393@yahoo.com", "49625961011", TipoCliente.PESSOAFISICA, pe.encode("abcde"));
		cli2.getTelefones().addAll(Arrays.asList("45932048", "984215739"));
